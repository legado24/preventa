...
import com.legado.preventagps.dialogs.supervisor.DialogEditByVendedorCarrito;
...
public class CarritoByVendedorRecyclerAdapter extends RecyclerView.Adapter<CarritoByVendedorRecyclerAdapter.CarritoRecyclerViewHolder> implements CarritoItemClickListener {
    ...
    private CarritoByVendedorFragment carritoFragment;
    ...
    public CarritoByVendedorRecyclerAdapter(List<CarritoCompras> detallePedidos, Context context, FragmentActivity activity, CarritoByVendedorFragment carritoFragment, TextView txtMonto, TextView titleList, Spinner spinnerVendFind, Spinner spinnerCondFind, Bundle args, MyDialogInfo.DialogInfoListener dialogInfoListener, Spinner spinnerAlmacenesFind) {
    ...
    public void onBindViewHolder(CarritoRecyclerViewHolder holder,final int position) {
        ...
        holder.btnEditar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 ...
                 DialogEditByVendedorCarrito newFragment = DialogEditByVendedorCarrito.newInstance(detallePedidos.get(position),position,carritoFragment,titleList,spinnerVendFind,spinnerCondFind,txtMonto,spinnerAlmacenesFind);
