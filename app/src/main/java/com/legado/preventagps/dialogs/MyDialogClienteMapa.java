...
public class MyDialogClienteMapa extends DialogFragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener ,GoogleMap.OnMyLocationButtonClickListener{
    ...
    public static MyDialogClienteMapa newInstance() {
        MyDialogClienteMapa fragment = new MyDialogClienteMapa();
        return fragment;
    }
...
//                    } else {
                    if(latLng==null){
                        ...
                        lc.setCoordenadas(latLng.latitude + "," + latLng.longitude);
//                    }
                        lc.setOperacion(5);
                        Gson gson = new Gson();
                        ...
                        Log.d("AAAAAA", latLng.latitude + "-" + latLng.longitude);
        ...
        call.enqueue(new Callback<JsonRespuesta<Integer>>() {
            ...
            public void onResponse(Call<JsonRespuesta<Integer>> call, Response<JsonRespuesta<Integer>> response) {
                if (response.body().getEstado() == -1) {
                    ...
                    editDialogClientHolderListener.showButtonGeolocalizar();
                    editDialogClientHolderListener.showButtonVerGeo();
                    Toast.makeText(getContext(), "Se geolocalizó correctamene " , Toast.LENGTH_LONG).show();
                    dismiss();
