...
public class MyDialogAlertaNoVencido extends DialogFragment{
    ...
    public static MyDialogAlertaNoVencido newInstance(BottomBar bottomBar, ActionBar actionBar) {
            MyDialogAlertaNoVencido fragment= new MyDialogAlertaNoVencido();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.layout_dialog_alert_novencido, container, false);
       ...
       final Button continuar = (Button) rootView.findViewById(R.id.continuar);
        ...
        continuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dismiss();
                getFragmentManager().beginTransaction().replace(R.id.contenedorFragment,preventaFragment,"PreventaFragment").setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE).commit();
            }
        });
        ...
        cobrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ft.replace(R.id.contenedorFragment, cobranzaFragment,"CobranzaFragment");
