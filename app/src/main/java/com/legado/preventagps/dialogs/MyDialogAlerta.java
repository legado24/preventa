...
public class MyDialogAlerta extends DialogFragment{
    ...
    public static MyDialogAlerta newInstance(BottomBar bottomBar, ActionBar actionBar) {
            MyDialogAlerta fragment= new MyDialogAlerta();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.layout_dialog_alert, container, false);
