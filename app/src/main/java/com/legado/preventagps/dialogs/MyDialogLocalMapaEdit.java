...
public class MyDialogLocalMapaEdit extends DialogFragment implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    public static MyDialogLocalMapaEdit newInstance(LocalCliente localCliente,String codigoCliente, MyDialogLocalMapaEdit.OnDialogFinishCallback listenerUpdate) {
        MyDialogLocalMapaEdit fragment = new MyDialogLocalMapaEdit(localCliente,codigoCliente,listenerUpdate);

        return fragment;
    }


    public static MyDialogLocalMapaEdit newInstance(LocalCliente localCliente) {
         MyDialogLocalMapaEdit fragment = new MyDialogLocalMapaEdit(localCliente);

        return fragment;
    }
    public MyDialogLocalMapaEdit(LocalCliente localCliente,String codigoCliente,MyDialogLocalMapaEdit.OnDialogFinishCallback listenerUpdate) {
        this.localCliente=localCliente;
        this.codigoCliente=codigoCliente;
        this.listenerUpdate=listenerUpdate;
    }

    public MyDialogLocalMapaEdit(LocalCliente localCliente) {
        this.localCliente=localCliente;
    }
        ...
        loginCall.enqueue(new Callback<JsonRespuesta>() {
            ...
            public void onResponse(Call<JsonRespuesta> call, Response<JsonRespuesta> response) {
                if (response.body().getEstado() == 1) {
                    ...
                    statusLocal.setAdapter(autoCompleteSimpleAdapter);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.layout_dialog_local_mapa_edit, container, false);
        ButterKnife.bind(this, rootView);
        toUpper();
         sessionUsuario = new SessionUsuario(getActivity());
        checkMyPermissionLocation(this);
        txtDireccFact.setText(localCliente.getDireccion());
