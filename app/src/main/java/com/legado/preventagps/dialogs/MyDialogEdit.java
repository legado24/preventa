...
public class MyDialogEdit extends DialogFragment {
    ...
    public static MyDialogEdit newInstance(CarritoCompras carritoCompras, int position , CarritoFragment carritoFragment, TextView titleList, Spinner spinnerVendFind, Spinner spinnerCondFind, TextView txtMonto,Spinner spinnerAlmacenFind) {
  ...
  EditText txtCantidad;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txtDisponibleEdit=(EditText)rootView.findViewById(R.id.txtDisponibleEdit);
        txtCantidad.setText(getArguments().getString(ARG_PARAM1));
        txtDisponibleEdit.setText(carritoComprasDialog.getArticulo().getDisponibleCanal().toString());
    ...
    private void actualizar(Bundle args) {
        ...
        CarritoFragment   carritoFragmentEdit=CarritoFragment.newInstance(titleListDialog,spinnerVendFindDialog,spinnerCondFindDialog,spinnerAlmacenesFindDialog);
    ...
    private boolean validar() {
        ...
        if(new Integer(txtCantidad.getText().toString())>new Integer(txtDisponibleEdit.getText().toString())){
            txtCantidad.setError("CANTIDAD EXCEDE AL DISPONIBLE");
            band = false;
        }else{
            txtCantidad.setError(null);
