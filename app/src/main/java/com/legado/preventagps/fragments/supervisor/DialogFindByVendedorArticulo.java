...
public class DialogFindByVendedorArticulo extends DialogFragment {
    private static final String TAG = "DialogFindByVendedorArticulo";
    ...
    public static DialogFindByVendedorArticulo newInstance(TextView titleLista, Spinner spinnerVend, Spinner spinnerCond, Spinner spinnerAlmacenes) {
        titleListaCount = titleLista;
        spinnerVendFind = spinnerVend;
        spinnerCondFind = spinnerCond;
        spinnerAlmacenesFind=spinnerAlmacenes;
        DialogFindByVendedorArticulo fragment = new DialogFindByVendedorArticulo();
        return fragment;
    }
